...
export default async function Page(){
 ...
 return <PlatformShell role="admin" name={me.full_name||'Administrador'}>
  ...
  <section className="payment-settings-wrap"><div className="panel-heading"><div><span className="section-kicker">CHECKOUT</span><h2>Métodos de pago manual</h2><p className="panel-subtitle">Pago Móvil para Venezuela y PayPal para clientes internacionales.</p></div></div><PaymentMethodSettings /></section>
