-- REBUSCÁNDOME — Recursos de producto para afiliados
-- Permite que afiliados activos accedan a recursos de productos activos.
...
select 'REBUSCÁNDOME: acceso de afiliados a recursos activos instalado' as result;
